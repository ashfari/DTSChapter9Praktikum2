package polinema.ac.id.dtschapter9praktikum2;
...
import polinema.ac.id.dtschapter9praktikum2.R;
import polinema.ac.id.dtschapter9praktikum2.data.AppDbProvider;
import polinema.ac.id.dtschapter9praktikum2.data.User;
import polinema.ac.id.dtschapter9praktikum2.data.UserDao;
...
public class WelcomeBackActivity extends AppCompatActivity {
    ...
    private static final String DUMMY_USERNAME = "sahab";
    ...
    {
        Intent i = new Intent(WelcomeBackActivity.this, polinema.ac.id.dtschapter9praktikum2.ForgotPasswordActivity.class);
        startActivity(i);
    }
    ...
    public void onBtnLogin_Click(View view)
    {
        ...
        if(valid)
        {
            Intent i = new Intent(WelcomeBackActivity.this, polinema.ac.id.dtschapter9praktikum2.HomeActivity.class);
            startActivity(i);
    ...
    {
        Intent i = new Intent(WelcomeBackActivity.this, polinema.ac.id.dtschapter9praktikum2.RegisterActivity.class);
        startActivity(i);
    }
...
//                && Objects.equals(currentPassword, DUMMY_PASSWORD));
        ...
        this.userValid = daoUser.findByUsernameAndPassword(currentUsername, currentPassword);
